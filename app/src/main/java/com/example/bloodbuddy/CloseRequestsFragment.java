...
public class CloseRequestsFragment extends Fragment {
   ...
   //change
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_close_requests, container, false);
    ...
    void loadRequest(){
        DatabaseReference myRef= databaseRef.child("userRequests").child(phone).child("closeRequests");
...
//                        Toast.makeText(getContext(), "3", Toast.LENGTH_SHORT).show();
                    ...
                    OpenCloseRequestAdapter ad=new OpenCloseRequestAdapter(list, getContext(),2);
